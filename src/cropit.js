...
class Cropit {
  ...
  onImageLoaded() {
    this.rotation = 0;
    this.horizontalFlipFactor = 1;
    this.verticalFlipFactor = 1;
    this.setupZoomer(
  ...
  renderImage() {
    const transformation = `
			...
			scale(${this.zoom * this.horizontalFlipFactor}, ${
      this.zoom * this.verticalFlipFactor
    })
  ...
  set horizontalFlipFactor(newHorizontalFlipFactor) {
    this._horizontalFlipFactor = newHorizontalFlipFactor;
    if (this.imageLoaded) {
      // Change in image size may lead to change in zoom range
      this.setupZoomer();
    }
  }
  get horizontalFlipFactor() {
    return this._horizontalFlipFactor;
  }
  flipH() {
    this.horizontalFlipFactor *= -1;
  }
  set verticalFlipFactor(newverticalFlipFactor) {
    this._verticalFlipFactor = newverticalFlipFactor;
    if (this.imageLoaded) {
      // Change in image size may lead to change in zoom range
      this.setupZoomer();
    }
  }
  get verticalFlipFactor() {
    return this._verticalFlipFactor;
  }
  flipV() {
    this.verticalFlipFactor *= -1;
  }
